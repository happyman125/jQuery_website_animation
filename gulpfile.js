...
//             removeComments: true
//         }))
//         .pipe(concat('tsCompiled.js'))
//         .pipe(sourcemaps.write())
//         .pipe(gulp.dest(distPath + 'ts'));
// });

gulp.task('typescript-compile', run('webpack'));
...
gulp.task('create-sprite', function() {
  ...
  let cssStream = spriteData.css
    .pipe(gulp.dest(distPath + 'css-sprite/'));
...
gulp.task('build-dev', function (callback) {
    gulpSequence(
        'clean',
        ['style', 'copy:scripts', 'copy:images', 'copy:svg', 'copy:fonts', 'copy:php', 'copy:video', 'typescript-compile', 'concat:scripts', 'concat:styles', 'create-sprite'],
        'html',
        callback
    );
});
...
gulp.task('build', function (callback) {
    gulpSequence(
        'clean',
        ['style-build', 'copy:scripts', 'copy:images', 'copy:svg', 'copy:fonts', 'copy:php', 'copy:video', 'typescript-compile', 'concat:scripts', 'concat:styles', 'create-sprite'],
...
gulp.task('serve', ['build-dev'], function () {
    ...
    gulp.watch('ts/**/*.ts', {cwd: srcPath}, ['watch:typescript']);
    gulp.watch('images/**/*.{jpg,jpeg,gif,png,svg}', {cwd: srcPath}, ['watch:images']);
    gulp.watch('svg/**/*.svg', {cwd: srcPath}, ['watch:svg']);
